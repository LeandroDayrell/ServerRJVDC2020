...
local valores = {
    ...
    { item = "wbody|WEAPON_PISTOL", quantidade = 1, compra = 3000, venda = 1500 },
	...
	{ item = "wammo|WEAPON_ASSAULTSMG", quantidade = 50, compra = 120, venda = 60 },
	...
	{ item = "wammo|WEAPON_PISTOL", quantidade = 50, compra = 100, venda = 60 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- COMPRAR
-----------------------------------------------------------------------------------------------------------------------------------------
