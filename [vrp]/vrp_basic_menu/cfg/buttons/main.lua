            ...
            SetTimeout(15000, function()
              ...
              if ndata ~= nil then
			    if ndata.inventory ~= nil then
                  ...
                  for k,v in pairs(ndata.inventory) do 
					...
					TriggerEvent("logs:serverLog", "ID "..user_id.." looteou "..v.amount.." "..vRP.getItemName(k).." do ID "..nuser_id..".", "loot", false)
	              end
				end
			  end
			  local weapons = vRPclient.replaceWeapons(nplayer, {})
				for k,v in pairs(weapons) do
				  ...
				  TriggerEvent("logs:serverLog", "ID "..user_id.." looteou 1 "..k.." do ID "..nuser_id..".", "loot", false)
				  if v.ammo > 0 then
					vRP.giveInventoryItem(user_id, "wammo|"..k, v.ammo, true)
					TriggerEvent("logs:serverLog", "ID "..user_id.." looteou "..v.ammo.." munição de "..k.." do ID "..nuser_id..".", "loot", false)
				  end
				end
			  local nmoney = vRP.getMoney(nuser_id)
			  if vRP.tryPayment(nuser_id,nmoney) then
			    vRP.giveMoney(user_id,nmoney)
				TriggerEvent("logs:serverLog", "ID "..user_id.." looteou "..nmoney.." reais do ID "..nuser_id..".", "loot", false)
			  end
            end)
