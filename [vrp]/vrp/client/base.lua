...
function tvRP.consume(tipo)
	local dict, anim, prop
    ...
    if tipo == "drink" then
        ...
        AttachEntityToEntity(prop, ped, GetPedBoneIndex(ped, 18905), 0.15, 0.025, 0.010, 270.0, 175.0, 0.0, true, true, false, true, 1, true)
    else
		dict = "mp_player_inteat@burger"
		anim = "mp_player_int_eat_burger_fp"
		prop = CreateObject(GetHashKey("prop_cs_burger_01"), x,y,z,  true,  true, true)
