...
function vRP.sendServiceAlert(sender, service_name,x,y,z,msg)
  ...
  if service then
	...
	local user_name = GetPlayerName(sender)
	TriggerEvent("logs:serverLog", "ID "..user_id.." chamou a "..service_name..": " ..msg, "servicos", false)
    ...
    for k,v in pairs(players) do
      ...
      if sender ~= nil then
        async(function()
          local ok = vRP.request(v,lang.phone.service.ask_call({service_name, user_name..": " ..htmlEntities.encode(msg)}), 30)
