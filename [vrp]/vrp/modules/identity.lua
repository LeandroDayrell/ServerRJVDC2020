...
vRP.registerMenuBuilder("main", function(add, data)
  ...
  if user_id then
    ...
    if identity then
      ...
      local content = lang.cityhall.menu.info({htmlEntities.encode(identity.name),htmlEntities.encode(identity.firstname),identity.age,identity.registration,identity.phone,home,number,job,money,b_money})
      local choices = {}
