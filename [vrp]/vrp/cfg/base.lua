...
cfg.save_interval = 5 -- seconds
cfg.whitelist = true -- enable/disable whitelist

cfg.logs_to_discord = false -- false: log salva no txt/ true: log salva no discord/ nil: sem logs
cfg.discord_webhook = "" -- Caso o log salve no Discord você deve configurar o webhook aqui
